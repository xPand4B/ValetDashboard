...
<head>
    <meta charset="UTF-8"/>
    <meta name="author" content="Eric Falsett"/>
...
<body class="bg-discord-primary min-h-screen antialiased">
    ...
    <div class="flex flex-row">
        <!-- Sidebar -->
        <div class="bg-discord-tertiary min-h-screen w-16 shadow-lg fixed">
            <!-- FABs -->
            <div class="flex flex-col items-center mt-5 space-y-5">
                ...
                <div>
                    <button
                        ...
                        title="Laravel Valet"
                    >
                        <svg viewBox="0 -.11376601 49.74245785 51.31690859" width="36" height="36" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w-full ml-16">
            ...
            <div class="bg-discord-primary py-3 pl-8 shadow-lg flex flex-row fixed w-screen select-none">
                ...
                <a
                    ...
                    target="_blank"
                    class="text-discord-header-secondary font-medium italic underline"
                >
                    PHP: <?=phpversion();?>
                </a>
                <div class="text-discord-header-secondary px-4">|</div>
                                ...
                                <div class="flex flex-col select-none">
                                    <?php foreach($sites as $site => $info): ?>
                                        <div class="flex flex-row items-center mb-2">
                                            ...
                                            <!-- Github Button -->
                                            <!-- <?php if($info['githubLink']): ?>
                                                <div
                                                    class="p-2 flex w-16 justify-center text-discord bg-indigo-800 hover:bg-indigo-900 italic rounded-r font-semibold cursor-pointer transition duration-150"
                                                    onclick="window.open('<?=$info['githubLink']?>')"
                                                >
                                                    Github
                                                </div>
                                            <?php endif; ?> -->
